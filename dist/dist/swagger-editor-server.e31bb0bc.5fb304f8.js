...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"swagger-editor-server.e31bb0bc.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (modules, cache, entry, globalName) {
    ...
    var _default = {
      load: function load() {
        ...
        var ui = SwaggerUIBundle({
          url: function () {
            if (window.SWAGGER_FILE === undefined) return "".concat(window.location, "/swagger.json");
  ...
  "index.js": [function (require, module, exports) {
    ...
    var url = 'http://localhost:9000/swagger.json';
    window.SWAGGER_FILE = url;
    window.onload = _main.default.load;
    ...
    ws.addEventListener('message', function incoming(data) {
      ...
      if (data.data === 'file changed') {
        ...
        var errorMessage = JSON.parse(data.data).message;
...
},{}]},{},["../../.config/yarn/global/node_modules/parcel/src/builtins/hmr-runtime.js","swagger-editor-server.e31bb0bc.js"], null)
//# sourceMappingURL=/swagger-editor-server.e31bb0bc.5fb304f8.map